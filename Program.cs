...
builder.WebHost.UseUrls("http://*:8080"); //By default port no(Container listening only on this port only) is 8080. This is very important because this port number only the cotainer listen remainings are getting error
